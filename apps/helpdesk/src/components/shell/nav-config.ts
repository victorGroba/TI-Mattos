...
export const navSections: NavSection[] = [
  {
    items: [
      ...
      { href: "/meus-equipamentos", label: "Meus equipamentos", icon: Laptop, matchPrefix: true },
      { href: "/projetos", label: "Projetos", icon: FolderKanban, roles: ADMIN_ONLY, matchPrefix: true },
      { href: "/inventario", label: "Inventário", icon: MonitorSmartphone, roles: ADMIN_ONLY, matchPrefix: true },
    ],
  },
  {
    label: "Administração",
